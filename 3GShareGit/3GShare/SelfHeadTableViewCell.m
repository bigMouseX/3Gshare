...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier {
    self = [super initWithStyle:style reuseIdentifier:@"selfhead"];
...
//    [_btn2 addTarget:self action:@selector(ViewButtonTapped:) forControlEvents:UIControlEventTouchUpInside];
    ...
    UIImage *t3 = [UIImage imageNamed:@"newimage1.png"];
...
- (void)layoutSubviews {
    CGFloat cellWidth = 150;
    CGFloat cellHeight = self.contentView.frame.size.height;
    
    _pictureView.frame = CGRectMake(15, 15, 120, 120);
    _titleLabel.frame = CGRectMake(150, 15, cellWidth, 25);
    _labelFirst.frame = CGRectMake(150, 40, cellWidth, 15);
    _labelSecond.frame = CGRectMake(150, 55, cellWidth, 15);
    _labelThird.frame = CGRectMake(150, 70, cellWidth, 15);
...
//    设置字体大小
    ...
    _labelThird.font = [UIFont systemFontOfSize:16.0];
