...
@interface SelfUpLoadViewController ()

@end

@implementation SelfUpLoadViewController
...
- (void)viewDidLoad {
    ...
    [_segControl insertSegmentWithTitle:@"上传最多" atIndex:0 animated:NO];
    [_segControl insertSegmentWithTitle:@"推荐最多" atIndex:0 animated:NO];
    [_segControl insertSegmentWithTitle:@"分享最多" atIndex:0 animated:NO];
